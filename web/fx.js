...
(() => {
  try {
    ...
    glow.style.cssText =
      ...
      "mix-blend-mode:multiply;transform:translate(-50%,-50%);left:-999px;top:-999px;" +
      "background:radial-gradient(circle,rgba(79,70,229,.05),rgba(124,58,237,.03) 45%,transparent 70%)";
