...
CHANGELOG = [
    ("redesign-0617", "🌾 Velký redesign: noční farma!", "Web dostal úplně nový kabát – tmavou hravou farmu se sedlákem maskotem! 🧑‍🌾 A přibyla hromada novinek: 🎟️ Farmářský Battle Pass (sezónní dráha odměn, reset každý měsíc – denní bonus, kolo i výhry máš na jednom místě), 🌱 Zahrádka (zasaď semínko, počkej, až doroste, a skliď sedláky), 🏆 Sezónní žebříček (kdo nasbíral nejvíc tento měsíc) a zkušenosti i úrovně – farmařením rosteš a tvou úroveň vidí všichni. Sbírej, sázej, farmař! 💜", "new", "2026-06-17T02:00:00+00:00"),
    ("cosmetics-0611", "🎨 Nová sekce: Kosmetika!", "Vyšperkuj si profil! Za sedláky si teď koupíš barvu přezdívky, rámeček avataru i profilový banner – a ukáže se to všude, kde tě ostatní vidí (žebříček, profil, nabídka). Od pár stovek po legendární animované efekty – zlatá, duhová, oheň 🔥. Některé kousky jsou jen pro suby. 💎 Najdeš to v nabídce pod sekcí Kosmetika.", "new", "2026-06-11T20:00:00+00:00"),
    ("fair-games-0608", "⚖️ Férovější hry – konec nekonečného sbírání", "Zatočili jsme s nekonečným farmařením: duely (mince/kostky) mají teď malý poplatek a krátkou pauzu mezi sebou a přibyl denní strop zisku ze her. Pro běžné hraní se skoro nic nemění – jen už nejde donekonečna sbírat a žebříček je férovější. 🎲", "improve", "2026-06-08T22:00:00+00:00"),
    ...
    ("stream-status", "Stav streamu v hlavičce", "Nahoře v nabídce teď svítí tečka, jestli stream běží živě 🟢 nebo je offline 🔴. Když je živě, klikni na ni a skočíš rovnou na stream.", "new", "2026-06-02T20:00:00+00:00"),
    ("raffle-limit", "Férovější tomboly – limit tiketů na osobu", "U tomboly jde teď nastavit maximum tiketů na osobu (% z celku), ať férovou tombolu neskoupí jeden boháč. Limit vidíš přímo na kartě.", "improve", "2026-06-02T14:00:00+00:00"),
    ("rank-tiers", "Tituly podle pozice + nová liga UNREAL", "Ligy jsou teď podle pozice na žebříčku: TOP 3 = 🌈 UNREAL (×10 na denní bonus!), TOP 10 ELITE, TOP 30 GOLD, TOP 50 SILVER, TOP 100 BRONZE. Tvůj titul je tvůj násobič denní série.", "improve", "2026-06-01T20:30:00+00:00"),
    ("daily-tier", "Denní bonus podle ligy", "Denní série teď násobí denní odměny podle tvé ligy – Bronze a Silver ×2, Gold ×3, Elite ×5.", "new", "2026-06-01T19:00:00+00:00"),
    ("mobile", "Optimalizace pro mobil", "Celý web teď pohodlně funguje i na telefonu – shop, žebříček, Exchange i predikce.", "improve", "2026-06-01T18:00:00+00:00"),
    ("sub-badges", "Automatické SUB odznaky", "Po subnutí, resubu nebo darovaném subu na Kicku se ti SUB odznak nahodí sám a po vypršení zase sundá.", "new", "2026-06-01T15:30:00+00:00"),
    ...
    ("live-pred", "Živé predikce", "Sázky u predikcí se aktualizují živě – nemusíš obnovovat stránku.", "new", "2026-05-31T18:00:00+00:00"),
    ("leaderboard", "Nový žebříček", "Pódium s medailemi, ligami a korunou pro prvního.", "improve", "2026-05-31T16:00:00+00:00"),
