...
CHANGELOG = [
    ("redesign-0617", "🌾 Velký redesign: noční farma!", "Web dostal úplně nový kabát – tmavá hravá farma se sedlákem maskotem! 🧑‍🌾 A přibyla hromada novinek: 🎟️ Farmářský Battle Pass (sezónní dráha odměn, reset každý měsíc – ber denní bonus, kolo i výhry na jednom místě), 🌱 Zahrádka (zasaď semínko, počkej až doroste a skliď sedláky), 🏆 Sezónní žebříček (kdo nasbíral nejvíc tento měsíc) a XP/Levely – farmařením rosteš a tvůj level vidí všichni. Sbírej, sázej, farmař! 💜", "new", "2026-06-17T02:00:00+00:00"),
    ("cosmetics-0611", "🎨 Nová sekce: Kosmetika!", "Vyšperkuj si profil! Za sedláky si teď koupíš barvu nicku, rámeček avataru i profil banner – a ukáže se to všude, kde tě ostatní vidí (leaderboard, profil, menu). Od pár stovek po legendární animované efekty – zlatá, rainbow, oheň 🔥. Některé kousky jsou jen pro suby. 💎 Najdeš to v menu pod sekcí Kosmetika.", "new", "2026-06-11T20:00:00+00:00"),
