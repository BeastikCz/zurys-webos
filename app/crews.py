...
def _achievements(c, members_count, sub_total):
    ...
    defs = [
        ...
        (c["war_wins"] >= 5, "⚔️", "5 výher ve válce"),
        (c["war_wins"] >= 10, "🛡️", "10 výher ve válce"),
        (c["war_wins"] >= 20, "🏆", "20 výher ve válce"),
        (c["war_wins"] >= 30, "👑", "30 výher ve válce"),
        (c["war_wins"] >= 40, "🔥", "40 výher ve válce"),
